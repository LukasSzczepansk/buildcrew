    ...
    return (
      <LegalPage title="Regulamin BuildCrew" subtitle={`Obowiązuje od ${EFFECTIVE_DATE_PL}. Ten regulamin określa zasady korzystania z BuildCrew.`}>
        ...
        <LegalSection title="8. Możliwości zawodowe i treści demonstracyjne">
          <p>Użytkownicy mogą zaznaczać otwartość na współpracę projektową, rozmowy z co-founderami, freelance, staże, zatrudnienie lub networking. Płatna współpraca może być opisana w ramach projektu. BuildCrew nie weryfikuje ani nie gwarantuje żadnej pracy, wynagrodzenia, inwestycji, zlecenia lub innej możliwości i nie jest pracodawcą ani agencją rekrutacyjną.</p>
        ...
        <LegalSection title="9. Wiadomości, powiadomienia i usługi zewnętrzne">
          <p>BuildCrew może oferować prywatne wiadomości oraz wysyłać e-maile transakcyjne dotyczące bezpieczeństwa konta, aplikacji, zaproszeń, wiadomości, aktywności projektów, dopasowań i innych zdarzeń związanych z kontem. Właściciel projektu może podać adres e-mail osoby spoza BuildCrew, aby wysłać jej jednorazowe zaproszenie do projektu. Dla wybranych kategorii mogą być dostępne ustawienia powiadomień.</p>
