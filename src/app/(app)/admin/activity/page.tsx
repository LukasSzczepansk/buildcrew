...
export default async function AdminActivityPage() {
  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[0.9fr_1.1fr]">
      <Card className="p-5">
        <div className="mb-5 flex items-center gap-2"><BarChart3 className="h-5 w-5 text-lime-600"/><div><h2 className="font-semibold">Aktywność produktu</h2><p className="text-xs text-neutral-400">Zdarzenia zapisane przez aplikację.</p></div></div>
      ...
      <Card className="overflow-hidden">
        <div className="flex items-center gap-2 border-b border-neutral-100 px-5 py-4 dark:border-neutral-800"><Activity className="h-5 w-5 text-lime-600"/><div><h2 className="font-semibold">Dziennik administracyjny</h2><p className="text-xs text-neutral-400">Historia działań wykonanych przez administratorów.</p></div></div>
