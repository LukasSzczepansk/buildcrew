...
export default async function NotificationsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <Topbar title="Powiadomienia" subtitle="Nowe wiadomości, zgłoszenia i zmiany w projektach." />
      ...
      ) : <p className="border-y border-[var(--bc-line)] py-10 text-center text-sm text-[var(--bc-muted)]">Brak powiadomień.</p>}
    </div>
  );
}
