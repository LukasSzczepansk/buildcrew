...
const OPTIONS: { key: CollaborationEndorsementStrength; pl: string; en: string }[] = [
  { key: "DELIVERY", pl: "Dowożenie", en: "Delivery" },
  { key: "COMMUNICATION", pl: "Komunikacja", en: "Communication" },
  { key: "TECHNICAL", pl: "Umiejętności techniczne", en: "Technical skills" },
  { key: "PRODUCT", pl: "Myślenie produktowe", en: "Product thinking" },
  { key: "DESIGN", pl: "Design", en: "Design" },
  { key: "RELIABILITY", pl: "Rzetelność", en: "Reliability" },
];
