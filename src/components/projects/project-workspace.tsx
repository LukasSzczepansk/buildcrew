...
function workspaceLabelSets(locale: "pl" | "en") {
  return {
    ...
    milestones: locale === "en"
      ...
      : { PLANNED: "Planowany", DOING: "In progress", DONE: "Completed" } as const,
    links: locale === "en"
...
function formatDateTime(value: string, locale: "pl" | "en") {
  return new Intl.DateTimeFormat(locale === "en" ? "en-GB" : "en-US", { day: "2-digit", month: "short", hour: "2-digit", minute: "2-digit" }).format(new Date(value));
}

function formatDate(value: string, locale: "pl" | "en") {
  return new Intl.DateTimeFormat(locale === "en" ? "en-GB" : "en-US", { day: "2-digit", month: "short", year: "numeric" }).format(new Date(value));
}
