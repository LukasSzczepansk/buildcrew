...
import { Hammer, HelpCircle, Home, Sparkles, User, Users } from "lucide-react";
...
export function MobileNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 flex justify-around border-t border-neutral-200 bg-white/95 px-1 py-1.5 backdrop-blur dark:border-neutral-800 dark:bg-neutral-950/95 lg:hidden">
      {NAV_ITEMS.map((item) => {
